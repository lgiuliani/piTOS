...
unsigned int fb_init()
{
	...
	if (result == 1 && framebuffer.pointer != (unsigned short *)0)
		fb = (unsigned short *)(((unsigned int)framebuffer.pointer) - 0xC0000000);
